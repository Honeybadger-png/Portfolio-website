  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="bg-tertiary p-5 rounde-2xl sm:w-[360px] w-full"
      >
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Following projects showcases my skills, experience through real-world
          ...
          problems, work with different technologies, collaborating skills and
      ...
      <div className="mt-20 flex flex-wrap gap-7">
        {projects.map((project, index) => (
          <Link key={`project-detail-${project.id}`} to={`/details/${project.id}`} state={{data:project}}>
