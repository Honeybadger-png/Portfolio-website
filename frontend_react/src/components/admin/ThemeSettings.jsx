      ...
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:[#484B52] w-400'>
        ...
        <div className="flex-col border-t-1 border-color p-4 ml-4">
          ...
          <div className='mt-4'>
            ...
            <label htmlFor="light" className='ml-2 text-md cursor-pointer text-slate-900'>Light</label>
          </div>
          <div className='mt-4'>
            <input type='radio' id='dark' name='theme' value='Dark' className='cursor-pointer' onChange={setMode} checked={currentMode === 'Dark'} />
            <label htmlFor="dark" className='ml-2 text-md cursor-pointer text-slate-900'>Dark</label>
          </div>
        </div>
        <div className="flex-col border-t-1 border-color p-4 ml-4">
          <p className="font-semibold text-lg text-slate-950">
