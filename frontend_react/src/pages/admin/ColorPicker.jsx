    ...
    <div className='m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl'>
      ...
      <div className='text-center'>
        ...
        <div className='flex justify-center items-center gap-20 flex-wrap'>
          <div>
            <p className='text-2xl font-semibold mt-2 mb-4 text-slate-700'>Inline Pallete</p>
            <ColorPickerComponent id='inline-pallete' mode='Palette' modeSwitcher={false} inline showButtons={false} change={change} />
          </div>
          <div>
            <p className='text-2xl font-semibold mt-2 mb-4 text-slate-700'>Inline Picker</p>
